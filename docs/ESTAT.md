...
| 2026-08-11 | **Cadena post-SQ separada dels literals EURUSD**: un contracte obligatori congela símbol, timeframe, timezone IANA i identitat Ostium per campanya. Temporal el contrasta amb el CFX, sizing/paritat amb candles i robustesa amb els costos observats. Forex conserva la semàntica provada d'overnight 0; commodity/índex/cripto exigeixen override positiu i usen el mínim entre límit general i overnight. Això permet reutilitzar la mateixa cadena per noves campanyes sense assumir pair 2/D1/100x. 932 tests + 19 subtests PASS. |
