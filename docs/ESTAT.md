...
| 2026-08-15 | **Portfolio Composer resol el sizing fix de la cartera 4-de-4**: extensió `AlquimiaFixedBudgetFloor` aplica `floor(500/preu)` per estratègia. Auditoria nativa 2022–2024: 94 acceptades, 0 rebutjades, màxim notional 499,45 USD, +32,91% brut i DD diari 5,80% sobre 2.000 USD. El +40,43% del MM integrat queda rebutjat perquè arrodonia cap amunt i excedia el sleeve; un primer custom també queda rebutjat perquè `sizeStep` generava mida zero. Costos SQ neutres: encara no és equivalència neta IBKR ni autorització paper/LIVE. |
| 2026-08-15 | **Gate IBKR pre-compte amb FX real**: creuament oficial ECB corregeix SGLN de 18 a 13 unitats perquè cotitza en GBP, no USD. El brut 2022–2024 baixa de +32,91% a +30,26%; després de costos públics indicatius: tiered +26,08%, fixed +18,71%, estrès +16,89% (337,74 USD sobre 2.000; ~5,3% anualitzat). Continua teòric: pla, venue, KID i fills reals només es poden confirmar amb compte; DD net diari no es reclama, paper/LIVE falsos. |
