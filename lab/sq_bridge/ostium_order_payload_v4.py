...
def build_order_template(*, config_path: Path, instruction: dict,
    ...
    return {
        ...
        "brokerage_async_contract": {
            "initial_http_status": 202,
            "initial_response_semantics": "pending_ack_not_fill",
            "operation_id_required": True,
            "operation_poll_endpoint_template": "/api/v1/broker/operations/{operation_id}",
            "terminal_states": ["confirmed", "error"],
            "executed_size_semantics": "gross_collateral_times_leverage_not_fill_proof",
            "post_open_position_reconciliation_required": True,
            "effective_notional_must_be_measured_from_confirmed_position": True,
        },
        "request_body": body,
