...
@BuildingBlock(name="(Alquimia) exact monthly momentum above",
    display="Alquimia month-end close @Chart@ #Months# months momentum [#Shift#] is above zero",
    returnType=ReturnTypes.Boolean)
@OppositeBlock(value="AlquimiaMonthlyMomentumBelow", oscillator=true, middleValue=0)
@ForEngine("*,-SP,-SA")
public class AlquimiaMonthlyMomentumAbove extends ConditionBlock {
