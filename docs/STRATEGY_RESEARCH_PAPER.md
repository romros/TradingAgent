...
| Admesa marginalment, capada | NFLX 0.4681 | NFLX | breakout de volatilitat D1 | MC natiu i 10/10 veïns passen; prova marginal eleva CAGR 16,00%→23,81% amb DD 19,29% |
...
NFLX és el cinquè edge de recerca defensable i supera el gate marginal de la
cartera canònica. L'admissió és teòrica, amb notional màxim de 1.000 USD; no
autoritza paper/live ni obre el holdout 2025+.
