...
| 2026-08-11 | **Holdout únic protegit per cobertura real**: `eurusd_v4_holdout_worker.py` només pot obrir una vegada l'únic candidat que passa sizing, espera SQ aliè i reprèn només el projecte propi. Nou gate: les candles certificades han d'arribar al final del holdout abans d'escriure la intenció d'obertura. Estat real: disponibles fins 2026-02-26, requerides fins 2026-07-31; decisió `WAITING_FOR_HOLDOUT_CANDLE_COVERAGE`, 0 avaluacions i cap CFX iniciat. |
| 2026-08-11 | **Traducció i paritat operatives després del holdout**: el cron únic continua `holdout→translation→parity`. La traducció només accepta el guanyador exacte d'una única avaluació final; la paritat crea un Retest pre-holdout nou, captura tots els senyals amb el probe JAR hashat, restaura l'SQCLI normal i compara SQ amb Python a nocional 200. Reobre tota la cadena temporal/robustesa/sizing/holdout per hash, és idempotent i manté paper/live falsos. Smoke real sense guanyador: `WAITING_FOR_FINAL_HOLDOUT→WAITING_FOR_TRANSLATION`, zero SQCLI iniciat. |
| 2026-08-11 | **Paquet paper-only automatitzat, execució encara prohibida**: `eurusd_v4_paper_package_worker.py` només accepta una paritat PASS i reobre preflight, sizing, holdout, traducció i paritat per hash. Genera configuració sense signer, `paper_started=false` i `live_authorized=false`; no crida cap motor ni envia ordres. Reexecució valida el paquet segellat sense reconstruir-lo. Smoke actual: `WAITING_FOR_PARITY`, cap paquet ni procés paper creat. |
| 2026-08-11 | **EURUSD D1 V2 elimina el bloqueig de cobertura del holdout**: la font NY-17 versionada combina la V1 immutable amb 119 sessions recents del cache Dukascopy↔Ostium congelat. Les 5 sessions solapades difereixen màxim 2,714 bps, dins del gate de 5 bps i queden substituïdes explícitament per la font recent. SQCLI importa i reexporta 5.998/5.998 candles amb OHLC 100% exactes, fins 07/08/2026. Registre, preflight, sizing i paritat apunten ara al símbol V2; el preflight només continua bloquejat per 11/30 mostres i 2/3 dies de costos. |
| 2026-08-11 | **Correcció fail-closed V3 abans d'accedir a rendiment**: V2 cobria el holdout però contenia cinc sessions posteriors al tall congelat i hauria desplaçat els splits posicionals. V3 es reconstrueix i importa sota un símbol nou, truncat exactament al 31/07/2026: 5.993/5.993 dates i OHLC 100% exactes després del round-trip SQ. Registre, worker i preflight apunten només a V3; V2 queda com evidència tècnica supersedida. Els perfils V4 no habiliten volum. |
| 2026-08-11 | **Direcció i calendari EURUSD preregistrats abans del screen**: cada mecanisme D1 (breakout, momentum, shock reversion) es divideix en `both`, `long` i `short`, 9 hipòtesis/27 variants train-only. La direcció passa per contracte fins al `MarketSides` del CFX i els validadors detecten qualsevol canvi. Els perfils permeten dia de setmana, però no hores intradia incompatibles amb D1 NY-17. Cap cost madur ni rendiment s'ha consultat per fer aquest canvi. |
| 2026-08-11 | **Objectiu de 60 candidats globals corregit**: el límit del databank era 64 per confusió amb `attempt_stop_guard=64`; una primera correcció encara l'aplicava per branca. Ara metodologia, pla, CFX, manifest i validador reparteixen exactament 60 entre totes les branques aprovades. El 64 es conserva exclusivament com reserva per aturar cada comptador a 9.936 i absorbir intents ja en vol sense superar 10.000. |
| 2026-08-11 | **Col·lisions de noms SQ multi-branca resoltes abans d'executar**: noms genèrics repetits com `Strategy 1.1.1` ja no bloquegen l'univers. Els SQX nadius romanen immutables; se'n deriva una còpia reproduïble amb ID global `ALQ_<hash branca+nom>`. L'univers conserva i el Retest reobre nom/ruta/hash nadius, transformació i branca; bytes idèntics es dedupliquen, noms iguals amb lògica diferent continuen com candidats diferents. |
| 2026-08-11 | **Mínim nocional Ostium incorporat al sizing**: cada candidat de 200 USDC compara tots els nocionals derivats de risc/stop amb el màxim `minNtl` de les captures congelades. Una ordre massa petita queda `REJECT` amb causa explícita a totes les palanques; no deixa el worker en error ni pot promocionar encara que PF, marge i liquidació passin. També s'han corregit al README les referències V1/holdout obsoletes: V3 cobreix 5.993 sessions fins al 31/07/2026. |
...
| 2026-08-11 | **Coordinador global de cartera fail-closed**: registre preregistrat i hashat de campanyes, obert fins incorporar els mercats independents i obligatori de tancar abans de seleccionar. Recorre SQ→temporal→robustesa→200 USDC, conserva també cada rebuig terminal, espera totes les campanyes i prohibeix rebuts posteriors a un rebuig. Només llavors crea el manifest global de 4–8 i el holdout verifica que el candidat/hash forma part de la cartera; amb només EURUSD registrat continua `WAITING_FOR_REGISTRATION_CLOSE`. |
| 2026-08-11 | **Cadena post-SQ separada dels literals EURUSD**: un contracte obligatori congela símbol, timeframe, timezone IANA i identitat Ostium per campanya. Temporal el contrasta amb el CFX, sizing/paritat amb candles i robustesa amb els costos observats. L'override overnight és específic del day trading d'accions: zero és no aplicable per forex/cripto/commodity/índex; una acció exigeix cap positiu i usa el mínim general/overnight. Això permet noves campanyes sense assumir pair 2/D1/100x. 932 tests + 19 subtests PASS. |
| 2026-08-11 | **Univers de sis campanyes preregistrat abans de rendiment**: BTC H4, ETH H4, EURUSD D1, US500 D1, USDJPY M15 i XAUUSD M15, amb tres mecanismes i both/long/short congelats. El registre ja està tancat; el coordinador exigeix totes sis terminals i ara inclou `REJECT_SCREEN_TRIGGER`, evitant espera infinita quan train descarta una campanya. Cap candidata ni performance consultada per seleccionar l'univers. |
| 2026-08-11 | **Costos cripto read-only en marxa**: smoke real resol BTC pair 0 i ETH pair 1, mínim 5 USD i cap live observat 100x; 1/30 captures cadascun. Cron separat a :17 cada hora, 24/7, amb 11 nocionals 10–14.000 USDC. Tot i que la taula pública anuncia BTC/ETH fins a 200x, Alquímia usarà el mínim live madur; signer, paper i ordres inexistents. L'override overnight 0 concorda amb cripto 24/7 i no es tracta com a cap zero. |
| 2026-08-11 | **US500 v4 preparat fins a screen sense mirar rendiment**: ID alineat a `us500-d1-alquimia-v4`; font D1 canònica reconstruïda exclusivament del M1 Dukascopy regular NY amb 2.088 sessions completes (2018-01-03→2026-07-08), exactament l'inventari del gate de cobertura i hash `44f2c0d8…`. El preflight reobre font/cobertura/mapping i només bloqueja pels costos de tres sessions. Nou productor independent de 27 variants train-only: momentum 126 dies, shock reversion i ROC20 de moviment gran, cadascun both/long/short amb dos veïns; replay detecta PnL forjat. PF no estimable passa a 0/rebuig de variant, no aborta la campanya. Cap performance US500 executada. |
| 2026-08-11 | **Fonts BTC/ETH H4 v4 reconstruïdes sense rendiment**: 100 ZIP BTC i 90 ETH oficials Binance passen la cadena SHA; els CSV M1 complets també coincideixen. Agregació estricta UTC conserva 18.215/18.264 blocs BTC (99,73%) i 16.390/16.428 ETH (99,77%); descarta 49/38 blocs incomplets, sense imputació. Els rebuts declaren explícitament que encara no autoritzen recerca. |
| 2026-08-11 | **Mapping Binance↔Ostium mesurat, no assumit**: el cron cripto ara envolta cada quote Ostium amb dos book tickers Binance i interpola al timestamp comú. Gate preregistrat: ≥240 parelles/60 dies/12 hores, bracket ≤45 s, base mediana ≤10 bps/p95 ≤25, corr. retorns ≥0,999 i error p95 ≤10 bps, més recorder Ostium natiu madur. Smoke real: 1 mostra per actiu, brackets 7–8 s i base ~−9,4 bps; decisió correcta `WARMING`, cap performance ni SQCLI. |
| 2026-08-11 | **Campanya crypto H4 preregistrada abans de mirar retorns**: BTC i ETH comparteixen holdout final 01/10/2025→30/06/2026; 18 hipòtesis noves (channel breakout, time-series momentum i volatility-compression breakout × both/long/short × dos mercats), rangs i pressupost global 60 tancats. Cap candidat ni resultat de les famílies històriques v11–v21 es reutilitza. |
| 2026-08-11 | **Roundtrip SQ BTC/ETH H4 exacte i preflight automàtic**: SQ 143.2708 importa/exporta `BTCUSD_ALQ_H4` 18.215/18.215 i `ETHUSD_ALQ_H4` 16.390/16.390 amb timestamps/OHLC exactes; el volum normalitzat queda exclòs de les regles. El preflight hasheja tota la cadena i ara bloqueja només per mapping de 60 dies i costos de 200 USDC immadurs (2 parelles sincronitzades i 4/30 captures cadascun). El cron el recompon cada hora; cap performance, candidat, paper o live consultat/autoritzat. |
| 2026-08-11 | **Disseny experimental crypto H4 congelat**: compilador propi materialitza lògicament 18 branques × 5.000 punts únics, 90.000 configuracions dins dels rangs preregistrats. Mostreig conjunt SHA-256 reproduïble; dues compilacions produeixen manifest byte a byte idèntic i hash combinat `cfc7f392…`. El pressupost 60 correspon a candidats acceptats globals. Cap candle, retorn, SQCLI, holdout, paper o live accedit. |
| 2026-08-11 | **Semàntica operativa crypto v4 segellada abans de performance**: contracte hashat fixa close→next-open, shift, ATR14 SMA, canals anteriors, ROC, percentil de compressió, una posició, stop-first, time exit, exclusió d'operacions obertes al límit train i ambigüitat both. Screen a 200 USDC/1x amb roundtrip i carry Ostium en base/conservador/estrès; leverage i compounding només post-robustesa. Verificador detecta deriva del disseny o del nocional. |
| 2026-08-11 | **Motor train-only crypto H4 implementat**: lector talla abans de parsejar OHLC futur, reinicia indicadors als gaps i exclou trades que els travessen sense inventar fills. Implementa breakout/momentum/compressió, next-open, stop-first, time exit i una posició. Mètriques base/conservador/estrès a 200 USDC inclouen carry, PF, EV, drawdown i tots els anys train. Proves cobreixen gaps, prioritat intrabar, ambigüitat i segell temporal; encara no s'executa performance real ni SQCLI. |
| 2026-08-11 | **Worker screen crypto recuperable i fail-closed**: checkpoints atòmics de 25 punts, replay exacte del disseny, hashes de preflight/font/costos/semàntica i represa contigua. Job BTC/ETH separat cada 10 minuts, lock i runtime persistent fora de Git; mai invoca SQCLI. Smoke real amb ambdós preflights BLOCK retorna `WAITING`, no obre candles/performance i no crea estat. Veïnat estable preregistrat: 4 més propers per Manhattan normalitzada, radi ≤0,15 i central+2 PASS. |
| 2026-08-11 | **Selector de regions i pla SQ crypto implementats sense performance**: regions solapades del mateix hypothesis es dedupliquen per rànquing i el pressupost 60 s'aplica després. Mètriques no finites i IDs duplicats fallen. Només una regió amb central+veïns reproduïts pot compilar un pla SQ: genètica 4 illes×100×25=10.000, 80/20, migració 5/10, màxim 3 regles, capital/nocional 200 USDC a 1x, costos SQ zero i revalidació Ostium obligatòria; màxim un promocionat/regió. Pla continua `sqcli_authorized=false`. |
| 2026-08-11 | **Replay global BTC+ETH integrat al cron**: finalitzador espera els dos preflights i les 18 branques completes, reobre chunks contigus contra el disseny i reexecuta cada central/veí potencial amb font i costos hashejats. Una diferència mínima de PnL falla. Només després publica selector `replay_verified`, deduplica i aplica els 60 compartits. Smoke BLOCK usa inputs design/runtime deliberadament inexistents i encara retorna WAITING sense estat, demostrant ordre fail-closed. |
| 2026-08-11 | **Sizing SQ cripto corregit abans de generar CFX**: `FixedSize=1` queda prohibit perquè equivaldria a 1 BTC/ETH. Font Java oficial SQ 143.2708 `CryptoSizeByPrice` reoberta i hashada (`aa393743…`): amb balance no dinàmic calcula initialBalance/preu. Contracte: 200 USDC, cap 100, 4 decimals BTC i 3 ETH. Al màxim canònic produeix 0,0016 BTC/0,040 ETH, mai el fallback intern a mida 1. Plans antics sense aquest MM queden invalidats. |
| 2026-08-15 | **JPM Momentum60 admesa com a tercera peça teòrica**: regla exacta sense tuning (`month change AND Close[1]>Close[61]`, hold 20) passa OOS natiu SQ 2024 amb 11 trades; 500 USD stress +19,39%, PF 2,409 i DD 5,27%. Confirmació preregistrada 2025–13/08/2026: 11 trades, +22,15%, PF 2,586 i DD 7,57%. Round-trip SQ 2.401/2.401 timestamps i OHLC exactes. Diagnòstic 2022–24 CAT+MSFT+JPM PASS: DD conjunt 10,68%, correlació JPM amb les altres ≈0. Paper/LIVE encara falsos. |
| 2026-08-15 | **Tres famílies falsificades sense gastar SQCLI**: SPY shock-reversal amb SMA200 (18 variants) i SPY reversió simètrica (36) no tenen regió estable després de costos; OOS SPY 2024 intacte. GLD breakout (9 variants) té tres veïns estables en desenvolupament, però l'únic E120/X60 congelat produeix zero trades completats al 2024 OOS i queda REJECT, sense valorar una posició censurada. Fonts Dukascopy PASS: SPY 1.901 i GLD 1.922 sessions RTH completes. |
| 2026-08-15 | **Turn-of-month SPY falsificada honestament**: una única regla acadèmica −1…+3, sense graella, és positiva en train (+15,76% net) i validació (+3,92%), però el t-stat combinat 1,410 no supera 1,645. Decisió `REJECT_DEVELOPMENT`; OOS 2024 roman segellat i no s'afinen dies per rescatar-la. PEAD queda separadament `BLOCK_DATA`: l'Item 2.02 de la SEC inclou anuncis no trimestrals i l'endpoint EDGAR retorna 403 des d'aquest entorn; no s'ha accedit a preus ni performance PEAD. |
| 2026-08-15 | **Quarta peça teòrica trobada: SGLN TSMOM12, limitada al 25%**. Confirmació 2025–07/2026: SGLN +42,13%, Sharpe 1,046; control PHAU +51,06%, correlació 0,960. Standalone 100% conserva REJECT perquè DD 25,82% >20%. Com a quart sleeve fix, CAT+MSFT+JPM+SGLN 2022–24 dona +28,26%, PF 1,534 i DD 6,95%, millor que el nucli (+22,72%, PF 1,369, DD 10,68%); correlació màxima or-resta 0,250. Estat `PASS_EDGE_AS_CAPPED_PORTFOLIO_SLEEVE`; paper/LIVE falsos i contracte IBKR encara per resoldre per ISIN/KID. També rebutjats: Halloween t-stat 1,493; AAPL intradia net negatiu a 1.000 USD; futurs TSMOM proxy Sharpe 0,553. |
| 2026-08-15 | **Auditoria de capital petit de les quatre peces**: amb quatre compartiments fixos del 25%, unitats senceres i sense leverage, 500 només executa SGLN; 1.000 i 1.500 encara deixen CAT fora. 2.000 és el primer punt viable de la graella: 128 esdeveniments, +21,99% 2022–24 i DD closed-equity 8,47%; a 3.000, +26,97% i DD 8,34%. Resultat diagnòstic, no holdout ni promesa. SQCLI Portfolio Master és adequat com a segona implementació només després de reconstruir totes quatre regles com SQX natiu i exigir paritat trade-a-trade; paper/LIVE falsos. |
| 2026-08-15 | **SGLN natiu en construcció, sense mirar performance**: bloc Java exacte de momentum de 12 finals de mes (cap proxy 252/253) compila i queda catalogat a SQ 143.2708; backup previ de `Snippets.jar` preservat. SQX net generat. Font SGLN convertida GBp→GBP i importada: 3.283 D1, 2012–2024; round-trip conserva 3.283 timestamps exactes, error OHLC màxim 0,00005049 GBP. Següent gate: retest 2019–24 i paritat trade-a-trade SQ/Python. Estat encara `NATIVE_SQX_PARITY_REQUIRED`; paper/LIVE falsos. |
| 2026-08-15 | **Cartera 4-de-4 executada nativament a SQ**: SGLN TSMOM12 passa paritat exacta 3/3 dates, tipus i preus. CAT, MSFT, JPM i SGLN es retesten sobre 2022–2024 i Portfolio Master produeix l'única combinació possible amb les quatre `PortfolioParts`. A 2.000, corba diària +13,52%, DD mark-to-market 3,17%; balanç tancat exportat 2.276,56 (+13,83%). És diagnòstic de diversificació amb una acció per trade i costos neutres, no equivalència amb sleeves 25% ni economia IBKR. Paper/LIVE falsos. |
| 2026-08-15 | **Portfolio Composer resol el sizing fix de la cartera 4-de-4**: extensió `AlquimiaFixedBudgetFloor` aplica `floor(500/preu)` per estratègia. Auditoria nativa 2022–2024: 93 ordres úniques, 0 rebutjades, màxim notional 499,45 USD, +32,91% brut i DD diari 5,80% sobre 2.000 USD. El log repetia literalment l'última CAT (94 línies); auditor corregit fail-closed. El +40,43% del MM integrat queda rebutjat perquè arrodonia cap amunt; un primer custom també queda rebutjat perquè `sizeStep` generava mida zero. |
| 2026-08-15 | **Gate IBKR pre-compte amb FX real**: creuament oficial ECB corregeix SGLN de 18 a 13 unitats perquè cotitza en GBP, no USD. El brut 2022–2024 baixa de +32,91% a +30,26%; després de costos públics indicatius: tiered +26,13%, fixed +18,83%, estrès +17,02% (340,47 USD sobre 2.000; ~5,3% anualitzat). Continua teòric: pla, venue, KID i fills reals només es poden confirmar amb compte; DD net diari no es reclama, paper/LIVE falsos. |
| 2026-08-15 | **Paritat agregada de cartera PASS amb abast explícit**: 93/93 dates d'entrada coincideixen entre Portfolio Composer i Python: CAT 57, MSFT 15, JPM 20, SGLN 1. Preu exacte CAT/JPM/SGLN (error màxim 0,00001/0,00001/0); MSFT valida només senyal perquè Python és ajustat i SQ nominal, tal com ja declarava el rebut individual. La comprovació va detectar i elimina una línia final duplicada del log SQ. Paper/LIVE falsos. |
| 2026-08-15 | **Cinquena estratègia de recerca: AAPL H1 Strategy 0.24306**. Retest natiu congelat: validació 2023 29 trades/PF brut 2,251; OOS 2024 24/PF 1,454. Conjunt 53 trades, mitjana +0,548%, PF 1,829 i t=2,099; bootstrap 10.000 dona 98% de mitjanes positives i eliminar els tres millors manté +0,434%/trade. A 1.000 USD, OOS tiered +5,39%, PF 1,308, DD 8,03%; stress compost 2023–24 +5,41%. Estat només `PASS_STATISTICAL_RESEARCH_EDGE`: 2024 stress −1,98%, benefici net anual concentrat i encara falten veïnat paramètric, traducció/paritat Python, correlació de cartera i holdout 2025+. També rebutjats honestament XOM TSMOM, SPY turn-of-month recent, Turtle 50/20 ampliada i AAPL 0.14113. |
| 2026-08-17 | **Earnings-gap continuation queda com a lead rebutjat**: regla única congelada (gap ≥3%, close fort, entrada next-open, hold 5) sobre calendaris SEC Item 2.02. L'expansió performance-blind d'11 a 16 equities manté 2022–2024 atractiu (17 trades, PF 2,637, t=1,327, 3/3 anys i 8 actius positius), però no arriba al mínim preregistrat de 20 i el train és fràgil (PF 1,024, compost −2,97%, DD 22,65%). No s'exclouen perdedors ni s'afinen paràmetres; paper/live falsos. |
| 2026-08-17 | **NFLX 0.4681 consolidada com a edge de recerca capat, encara fora cartera**: OOS 2024 a 1.000 USD stress +31,33%, PF 5,65, DD 5,36%; paritat independent i M1 central passen. Decoder natiu confirma 2.000 simulacions de paràmetres ±10%, 100% rendibles i p05 +8,16% sobre balanç SQ. La remediació uniforme al 50% dona 10/10 veïns positius, PF 1,88–2,44 i DD 6,73–18,01%; dos same-bar del stop225 confirmats cronològicament amb M1. El REJECT original a 100% no s'esborra: falta prova marginal amb la cartera canònica i holdout 2025+ continua tancat. |
| 2026-08-17 | **NFLX 0.4681 supera el gate marginal canònic**: amb capital inicial 2.000 USD, límit global de préstec 2.000 USD, prioritat de la cartera base i notional NFLX màxim 1.000 USD, el stress 2022–2024 passa de +56,04% a +89,73% (CAGR 23,81%), DD 19,29%, 26/26 operacions executades, PF 2,43 i 36,58 USD de finançament incremental. Admissió teòrica capada; paper/live continuen prohibits i el FAIL original uncapped no es reescriu. |
