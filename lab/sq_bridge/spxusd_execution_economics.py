...
def audit(*, capitals=(200.0, 500.0), risk_pct=1.0,
          stop_distances_pct=(1.0, 0.5, 0.25), opening_fee_bps=1.0,
          observed_closed_spread_bps=0.9672048772, observed_slippage_bps=0.4836024386,
          oracle_fee_usdc=0.10, venue_max_leverage=100.0,
    ...
    for capital in capitals:
        ...
        for stop_pct in stop_distances_pct:
            ...
            rows.append({
                ...
                "single_closed_snapshot_entry_cost_bps": round(
                    opening_fee_bps + observed_closed_spread_bps + observed_slippage_bps, 6),
    ...
    return {
        ...
        "facts": {
            ...
            "live_snapshot_max_leverage": venue_max_leverage,
            "live_snapshot_min_notional_usd": 5.0,
            "live_snapshot_overnight_max_leverage": 0.0,
        ...
        "scenario_assumptions": {
            ...
            "single_closed_snapshot_spread_bps": observed_closed_spread_bps,
            "single_closed_snapshot_slippage_bps": observed_slippage_bps,
            "snapshot_warning": "market closed; do not use as an open-session distribution",
        },
        ...
        "gates": {
            ...
            "missing": [
                ...
                "measured slippage distribution for intended notionals",
