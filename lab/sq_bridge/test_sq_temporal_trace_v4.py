...
def _sources(tmp_path, rows):
    ...
    header = '"Ticket";"Type";"Open time";"Open price";"Close time";"Close price";"Size";"MAE ($)"'
    orders.write_text("\n".join([header, *rows]) + "\n")
...
def test_derives_train_and_annual_oos_windows_from_observed_sq_orders(tmp_path):
    orders, contract, costs, receipt = _sources(tmp_path, [
        '"1";"Buy";"2020.01.02 10:00:00";"1.0000";"2020.01.03 10:00:00";"1.0100";"100";"-2"',
        '"2";"Sell";"2021.02.01 10:00:00";"1.0000";"2021.02.02 10:00:00";"0.9900";"100";"-3"',
        '"3";"Buy";"2022.03.01 10:00:00";"1.0000";"2022.03.03 10:00:00";"1.0200";"100";"-4"',
    ])
    trace = derive(
...
@pytest.mark.parametrize(("row", "message"), [
    ('"1";"Buy";"2022.12.30 10:00:00";"1";"2023.01.03 10:00:00";"1.01";"100";"-2"',
     "holdout"),
    ('"1";"Buy";"2020.12.30 10:00:00";"1";"2021.01.03 10:00:00";"1.01";"100";"-2"',
     "frontera"),
])
...
def test_rejects_ambiguous_dst_timestamp(tmp_path):
    orders, contract, costs, receipt = _sources(tmp_path, [
        '"1";"Buy";"2021.11.07 01:30:00";"1";"2021.11.08 10:00:00";"1.01";"100";"-2"',
    ])
