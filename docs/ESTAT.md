...
| 2026-08-11 | **Objectiu de 60 candidats corregit**: el límit del databank era 64 per confusió amb `attempt_stop_guard=64`. Ara metodologia, pla, CFX, manifest i validador fixen 60 acceptats per branca; 64 es conserva exclusivament com reserva per aturar el comptador a 9.936 i absorbir intents ja en vol sense superar 10.000. |
