...
| 2026-08-10 | **Transformació de costos US500 preregistrada**: només pot congelar base=p50 i conservador=p95 després del gate de tres dies; estrès usa `max(2×p50,p95)` i només aquí perd els 0,10 USDC de l'oracle. Base/conservador respecten el reemborsament del full close. Valida obligatòriament nocionals 60/100/200/400/500, limita credits de rollover a zero i no autoritza paper/live. Estat actual: BLOCK fins tenir tres sessions completes. |
