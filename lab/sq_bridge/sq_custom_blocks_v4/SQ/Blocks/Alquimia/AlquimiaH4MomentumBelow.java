...
@BuildingBlock(name="(Alquimia) H4 continuous momentum below",
    display="Alquimia H4 ROC(@Chart@#Period#)[#Shift#] < -#Level#%",
    returnType=ReturnTypes.Boolean)
@OppositeBlock(value="AlquimiaH4MomentumAbove", oscillator=true, middleValue=0, field="Level")
@ForEngine("*,-SP,-SA")
public class AlquimiaH4MomentumBelow extends ConditionBlock {
    ...
    @Override public boolean OnBlockEvaluate() throws TradingException {
        return AlquimiaH4Signals.momentumBelow(Chart, Period, Level, Shift);
    }
}
