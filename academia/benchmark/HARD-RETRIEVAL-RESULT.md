...
Corpus: 34 fonts; motor SQLite FTS5/BM25 amb stopwords i cobertura lexical mínima.
Dataset: 26 preguntes — 23 answerables, 3 que exigeixen abstenció.

## Resultat 2026-08-02

- Recall@5 answerable: **0,87**;
- MRR@5 answerable: **0,89**;
- no-answer accuracy: **1,00**;
- quatre consultes noves de deriva de contracte: Recall@5 **1,00** i MRR@5 **0,88**;
- benchmark lexical original (27 preguntes): Recall@5 i MRR@5 **1,00**.
...
No activar embeddings encara. Vint-i-sis preguntes difícils són insuficients per justificar
